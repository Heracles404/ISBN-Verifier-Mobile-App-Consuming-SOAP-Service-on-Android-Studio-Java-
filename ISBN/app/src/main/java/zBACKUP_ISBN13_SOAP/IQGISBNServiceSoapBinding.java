...
public class IQGISBNServiceSoapBinding
{
    ...
    public IQGISBNServiceSoapBinding()
    {
    }

    public IQGISBNServiceSoapBinding(String url)
    {
        this.url=url;
    }

    public IQGISBNServiceSoapBinding (String url,IQGConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        IQGRequestResultHandler handler = new IQGRequestResultHandler(IQGSoapVersion.v1_1);
        return handler;
    }
